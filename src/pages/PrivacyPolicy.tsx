    ...
    <div className="min-h-screen bg-orange-50 py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
          <h1 className="text-4xl font-bold text-orange-900 mb-6">Your Sacred Digital Space</h1>
          <p className="text-orange-800 mb-8 text-lg">Last Updated: 01-01-2025 | Your Trust, Our Spiritual Commitment</p>

          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-orange-900 mb-4 border-b-2 border-orange-200 pb-2">📜 Information We Collect</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-orange-900 mb-4 border-b-2 border-orange-200 pb-2">🕉️ Sacred Usage</h2>
            <p className="text-gray-700 mb-6 leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-orange-900 mb-4 border-b-2 border-orange-200 pb-2">🤝 Dharma Sharing</h2>
            <p className="text-gray-700 mb-6 leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-orange-900 mb-4 border-b-2 border-orange-200 pb-2">🔐 Divine Rights</h2>
            <p className="text-gray-700 mb-6 leading-relaxed">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-orange-900 mb-4 border-b-2 border-orange-200 pb-2">📮 Connect with Keepers</h2>
