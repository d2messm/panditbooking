...
const GrahaShantiPuja = () => {
  ...
  const pujaDetails = {
    ...
    rating: 4.9,
    reviews: 50,
    description: "Graha Shanti Puja is performed to pacify the malefic effects of planets and bring harmony to one's life. This puja helps in removing obstacles and bringing peace and prosperity.",
    benefits: [
      "Removes negative planetary influences",
      "Brings peace and harmony",
      "Improves career prospects",
      "Enhances overall well-being",
      "Protects from malefic effects"
    ],
    items: [
      "Navgraha Yantra",
      "Special Herbs",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="rounded-lg overflow-hidden shadow-lg">
              <img
                src="/images/graha-shanti-puja.jpg"
...
export default GrahaShantiPuja; 