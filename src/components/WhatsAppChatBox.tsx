  ...
  return (
    <div>
      <button
        ...
        className="fixed bottom-4 right-4 bg-accent text-white p-3 rounded-full shadow-lg hover:bg-accent-light transition"
      ...
      {isOpen && (
        <div className="fixed bottom-16 right-4 bg-white p-4 rounded-lg shadow-lg w-64">
          <h3 className="text-lg font-bold mb-2">Chat with us on WhatsApp</h3>
          <p className="text-sm mb-4">We are here to help you. Click below to start a chat.</p>
          <button
            onClick={handleChat}
